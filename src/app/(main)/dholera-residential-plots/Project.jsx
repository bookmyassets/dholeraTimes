  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: '#fbfbfb'}}>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-8">
              <h2 
                ...
                style={{color: '#151f28'}}
              >
                High-Growth Opportunities in <span style={{color: '#d3b36b'}}>Dholera</span>
              </h2>
              <p 
                        ...
                        {availableProjects[0].mainImage && (
                          <div className="relative h-[300px]">
                            ...
                            <div className="absolute top-6 left-6 flex flex-wrap gap-3 z-20">
                              {availableProjects[0].categories && Array.isArray(availableProjects[0].categories) ? (
                                availableProjects[0].categories
                                  .filter(category => category.title !== "Sub-Project" && category.title.toLowerCase() !== "sold out")
                                  .slice(0, 2)
                                  .map((category, index) => (
                                    <span
                                      key={index}
                              ...
                              ) : availableProjects[0].categories && availableProjects[0].categories.title !== "Sub-Project" && availableProjects[0].categories.title.toLowerCase() !== "sold out" ? (
                                <span
                                  className="px-4 py-2 text-sm font-semibold rounded-full shadow-lg backdrop-blur-sm border-2"
                                  style={{
                                    backgroundColor: 'rgba(211, 179, 107, 0.9)',
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="prose prose-slate max-w-none">
                            <div 
                              ...
                              style={{color: 'rgba(21, 31, 40, 0.7)'}}
                            >
                              <PortableText value={availableProjects[0].body} />
                            </div>
                          </div>
                    ...
                    >
                      <div className="text-center  mb-4">
                        ...
                        <p 
                          ...
                          style={{color: 'rgba(251, 251, 251, 0.8)'}}
                        >
                          Get detailed information and secure your investment opportunity
                        </p>
                      </div>
                        ...
                        >
                          ...
                          <div className="relative h-64">
                            ...
                            <div className="absolute top-4 left-4 flex flex-wrap gap-2 z-20">
                              ...
                              ) : post.categories && post.categories.title !== "Sub-Project" && post.categories.title.toLowerCase() !== "sold out" ? (
                                <span
                                  className="px-3 py-1 text-xs font-semibold rounded-full backdrop-blur-sm border"
                                  style={{
                                    backgroundColor: 'rgba(211, 179, 107, 0.9)',
      ...
      {soldOutProjects.length > 0 && (
        <div className="py-20" style={{backgroundColor: 'rgba(21, 31, 40, 0.05)'}}>
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              {soldOutProjects.map((post) => (
                <div key={post._id} className="group">
                  <div 
                    className="rounded-2xl shadow-xl overflow-hidden border-2 hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] relative"
                    style={{
                      backgroundColor: '#fbfbfb',
                      borderColor: 'rgba(211, 179, 107, 0.2)'
                    }}
        ...
        <div className="py-20">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p 
              ...
              style={{color: 'rgba(21, 31, 40, 0.7)'}}
            >
              We're preparing exciting new investment opportunities. Stay tuned for updates.
            </p>
          </div>
        </div>
      )}
