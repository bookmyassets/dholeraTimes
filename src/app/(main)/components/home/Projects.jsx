...
const   BrowsePropertiesSection = () => {
  ...
  return (
    <section className="relative py-8 px-6 md:px-36">
      <Image
        src={bg}
      ...
      <div className="container mx-auto">
        <div className="w-full px-2 mb-10 text-center">
          ...
          <p className="text-sm md:text-base max-w-2xl mx-auto text-gray-600 mt-4">
            Explore Our Dholera Smart City Projects
          </p>
        </div>
                    ...
                    <div className="rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl hover:-translate-y-1 h-full bg-white">
                      <div className="relative h-64">
                        ...
                        {project.categories?.some(
                          ...
                          <div
                            className="absolute top-0 right-0 py-1 px-3 m-2 rounded-md font-bold z-10 shadow-md"
                            style={{
                              backgroundColor: brandColors.soldOut,
                              color: "white",
                            }}
                          >
                            SOLD OUT
                        ...
                        <div
                          className={`absolute inset-0 flex items-end transition-opacity duration-300 ${
                            project.categories?.some(
                              ...
                              ? "opacity-30" // Always show overlay for sold out items
                              : "opacity-0 hover:opacity-100" // Show on hover for available items
                          }`}
                        >
                          <div className="p-4 text-[#151f28] w-full">
                      ...
                      <div className="p-5">
                        ...
                        >
                          <button
                            className={`w-full px-4 py-2 text-white transition-colors duration-300 rounded-md ${
                              project.categories?.some(
                                (cat) => cat.title === "Sold Out"
                              )
                            ...
                            style={{
                              backgroundColor: project.categories?.some(
                                (cat) => cat.title === "Sold Out"
                              )
                                ? "#888888"
                                : brandColors.gold,
