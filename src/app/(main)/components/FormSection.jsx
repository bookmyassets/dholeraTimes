              ...
              <form onSubmit={handleSubmit} className="mt-12 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-[#d8b66d]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-5 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-[#d8b66d]"
