  ...
  return (
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        {/* Mission */}
        <div className="mb-12">
          <div className="bg-[#151f28] p-10 rounded-2xl text-white relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#d3b36b]/20 rounded-full -translate-y-16 translate-x-16"></div>
            <div className="flex items-center mb-6 relative z-10">
              <div className="bg-[#d3b36b] p-3 rounded-xl mr-4">
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
                <span className="text-gray-100">To make property exploration hassle-free, transparent, and reliable.</span>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
                <span className="text-gray-100">To guide investors, NRIs, and channel partners with expert insights and trusted updates.</span>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
                <span className="text-gray-100">To deliver long-term value through verified information on premium projects in India's fastest-growing smart city.</span>
              </div>
            </div>
          </div>
        </div>
         ...
         <div className="grid lg:grid-cols-2 gap-8 mb-8">
          {/* Vision */}
          <div className="bg-[#d3b36b] p-8 rounded-2xl text-white transform hover:scale-105 transition-transform duration-300">
        ...
        {/* Promise */}
        <div className="border-2 border-[#d3b36b] p-8 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center mb-6">
            <div className="bg-[#d3b36b]/10 p-3 rounded-xl mr-4">
              <Shield className="h-8 w-8 text-[#d3b36b]" />
            </div>
            <h3 className="text-2xl font-bold text-[#151f28]">Our Promise</h3>
          </div>
          <p className="text-gray-700 mb-6 text-lg">At <strong className="text-[#d3b36b]">Dholera Times</strong>, we promise to:</p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
              <span className="text-gray-700">Deliver verified updates you can trust.</span>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
              <span className="text-gray-700">Provide transparent guidance with no hidden agendas.</span>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
              <span className="text-gray-700">Keep you informed with real-time growth insights.</span>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#d3b36b] mr-3 mt-1 flex-shrink-0" />
              <span className="text-gray-700">Stand as your long-term partner in every investment decision.</span>
            </div>
          </div>
        </div>
      </div>
