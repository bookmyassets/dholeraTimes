...
export default function Hero() {
  ...
  return (
    <>
      <title>Orchid Dholera | Premium Plots Near Activation Area</title>
      <meta
        name="description"
        content="Explore Orchid Dholera plots near the Activation Area on Dholera Times - a prime location offering strong investment potential in Smart City Dholera."
      />
      <meta
        name="keywords"
