      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            Ahmedabad-Dholera Expressway and the proposed Dholera International
            Airport, the project offers secure residential plots with approvals
            and modern facilities as part of India’s Greenfield Smart City.
          </p>
        </div>
          ...
          <div className="space-y-8 h-full">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-gray-100/50 h-full transform hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-gray-700 mb-8 leading-relaxed text-lg border-l-4 border-[#debe6b] pl-4 italic">
                " Marina Bay combines strategic location with modern
