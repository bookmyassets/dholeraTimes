    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-2 border-[#d3b36b] p-8 rounded-2xl bg-[#d3b36b] shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-white mb-6 text-lg">At <strong className="text-white">Dholera Times</strong>, we promise to:</p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#151f28] mr-3 mt-1 flex-shrink-0" />
              <span className="text-white">Deliver verified updates you can trust.</span>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#151f28] mr-3 mt-1 flex-shrink-0" />
              <span className="text-white">Provide transparent guidance with no hidden agendas.</span>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#151f28] mr-3 mt-1 flex-shrink-0" />
              <span className="text-white">Keep you informed with real-time growth insights.</span>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-[#151f28] mr-3 mt-1 flex-shrink-0" />
              <span className="text-white">Stand as your long-term partner in every investment decision.</span>
            </div>
          </div>
        </div>
      </div>
