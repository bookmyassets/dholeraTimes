      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold leading-tight font-poppins tracking-tight">
            WHY INVEST IN{" "}
            <span className="text-[#d7b36c] relative">DHOLERA TIMES</span>'s
  ...
  <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300">
    ...
    <div className="p-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12 max-w-4xl mx-auto">
          <ul className="space-y-8">
            <li className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-2xl font-semibold text-gray-800 font-poppins">
                  With Dholera Times you get NA/NOC Plots
                </p>
                <p className="mt-1 text-lg font-medium text-gray-600 font-poppins">
                  All plots are fully compliant with regulations
                </p>
              </div>
            </li>
            ...
            <li className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-2xl font-semibold text-gray-800 font-poppins">
                  AUDA registered plots
                </p>
                <p className="mt-1 text-lg font-medium text-gray-600 font-poppins">
                  Legal assurance and government approval
                </p>
              </div>
            </li>
      ...
      <section>
        ...
        <div className="bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl shadow-lg p-8 mb-12 ">
          <div className="flex flex-col md:flex-row items-center gap-8 max-w-7xl mx-auto">
            <div className="md:w-1/2">
              <h3 className="text-3xl md:text-5xl font-bold text-gray-800 font-poppins mb-4">
                Investment Returns
              </h3>
            ...
            <div className="md:w-1/2">
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
                  <div
                    className="bg-[#d7b36c] h-2.5 rounded-full"
                    style={{ width: "80%" }}
                  ></div>
                </div>
        ...
        <div className="bg-[#151f28] rounded-xl shadow-lg p-8 mb-12  text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              ...
              className="bg-[#d3b469] text-2xl hover:bg-[#c0a355] text-[#151f28] font-bold py-3 px-6 rounded-lg transition-all"
            >
              Get Free Consultation
            </button>
            <Link
              href="tel:+919958993549"
              className="inline-block text-2xl px-8 py-4 bg-transparent border-2 border-white hover:bg-white hover:text-[#151f28] text-white font-bold rounded-lg transition duration-300 transform hover:scale-105 font-poppins "
            >
              Call Now
            </Link>
          </div>
        ...
        <div className="w-full relative mt-8">
          <div className="hidden sm:block relative">
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
              <Link
                href="tel:+919958993549"
                className="inline-block px-6 py-3 text-3xl font-bold rounded-lg transition duration-300 transform hover:scale-105 font-poppins"
                style={{
          ...
          <div className="sm:hidden relative">
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
              <Link
                href="tel:+919958993549"
                className="inline-block px-6 py-3 text-xl font-bold rounded-lg transition duration-300 transform hover:scale-105 font-poppins"
                style={{
                  backgroundColor: currentColor.bg,
                  color: currentColor.text,
                }}
